...
<%@ page import="com.jarod.pojo.FileInfo" %>
...
<%--                <button type="button" class="btn btn-outline-success">上传文件</button>--%>
                <input type="submit" class="btn btn-outline-success" value="上传文件">
                <input type="file" name="uploadFile" style="width: 200px;" /></span>
                <p></p>
                <table class="table table-dark table-hover"
                       style="background-color: #343a40;opacity: 0.8;border-radius: 10px;">
                    <thead>
                    <tr>
                        <th>文件名</th>
                        <th>上传日期</th>
                    ...
                    <tr>
                        <td>
                            <%
                                out.print(dao.finddate(userInfo.get(i).getUser_id()).getFile_name());
                            %>
                        </td>
                        <td>
                            <%

                                out.print(dao.finddate(userInfo.get(i).getUser_id()).getFile_date());
                            %>
                        </td>
                        <td>
                            <button type="button" class="btn btn-outline-primary">公开</button>
                        </td>
                        <td>
                            <%
