            ...
            <div class="page-inner">
                ...
                <table class="table table-dark table-hover"
                    ...
                    %>
                        <tr>
                            <td><%
                                List<FileInfo> fileInfo = (List<FileInfo>) request.getSession().getAttribute("fileinfo");
                                //获取session中的公共文件的属性
                                FileInfo fileInfo1 = fileInfo.get(i);
                                //获取第i个公共文件的属性
                                out.print(fileInfo1.getFile_name());
                            %></td>
                            <td><%
                                //获取工厂对象 利用id查询用户名
                                ...
                                Integer userid=fileInfo1.getFile_user_id();
                                out.print(dao.findbyid(userid).getUsername());
                            %></td>
                            <td><%
                                out.print(fileInfo1.getFile_date());
                            %></td>
...
<%--                        <td><%--%>
<%--                            List<FileInfo> fileInfo = (List<FileInfo>) request.getSession().getAttribute("fileinfo");--%>
<%--                            FileInfo fileInfo1 = fileInfo.get(1);--%>
<%--                            out.print(fileInfo1.getFile_name());--%>
<%--                        %></td>--%>
<%--                        <td>Doe</td>--%>
<%--                        <td>2001.1.12</td>--%>
<%--                        <td>--%>
<%--                            <button type="button" class="btn btn-outline-success">下载</button>--%>
<%--                        </td>--%>
<%--                    </tr>--%>
